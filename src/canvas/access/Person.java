package canvas.access;

// encapsulation is the bundling of related properties and behavior
// and protecting them from undesired canvas.access

// canvas.access modifiers
...
public class Person {
    ...
    public void code() {
        // allowed because Person and Computer both reside within the canvas.access package
        pc.code();
    }
}
...
//        person.age = -1;
        ...
        // allowed because the pc property has default canvas.access modifier: visible within the package
